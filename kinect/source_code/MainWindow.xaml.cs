...
namespace Microsoft.Samples.Kinect.FaceBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            pub_human = new Publisher("/kinect_human", "kinect_human", "direct", "192.168.11.43", "9090");
            // Init publishers
            pub_sound = new Publisher("/kinect_sound", "kinect_sound", "direct", "192.168.11.43", "9091");
            publish_data = true;
        }
